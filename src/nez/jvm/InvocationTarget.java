...
public class InvocationTarget {
	...
	public InvocationTarget(InvocationType type, Class<?> ownerClass, Class<?> returnClass,
	...
	public static InvocationTarget newStaticTarget(Class<?> ownerClass, Class<?> returnClass,
			String methodName, Class<?>... paramClasses) {
		return new InvocationTarget(InvocationType.INVOKE_STATIC, ownerClass, returnClass,
				methodName, paramClasses);
	}

	public static InvocationTarget newVirtualTarget(Class<?> ownerClass, Class<?> returnClass,
			String methodName, Class<?>... paramClasses) {
		return new InvocationTarget(InvocationType.INVOKE_VIRTUAL, ownerClass, returnClass,
				methodName, paramClasses);
	}

	public static InvocationTarget newInterfaceTarget(Class<?> ownerClass, Class<?> returnClass,
			String methodName, Class<?>... paramClasses) {
		return new InvocationTarget(InvocationType.INVOKE_INTERFACE, ownerClass, returnClass,
				methodName, paramClasses);
	}
}
